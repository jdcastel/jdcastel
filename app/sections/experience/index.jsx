			...
			<section id="experience" className="section">
				...
				<VerticalTimeline>
					...
					>
						...
						<h3 className="text-light">Developed a web-based project management application using the MERN stack that allowed clients to view the progress of pending tasks.<br/>Led a project team providing guidance and direction facilitating communication and collaboration to ensure timely and successful completion of the project.<br/>Collaborated with an agile team of developers and project managers to create a customized PowerApps application for over 1000 users.<br/>Contributed to the design and implementation of key features, such as data integration with existing systems and user-friendly interface design.<br/>Identified and resolved software bugs through rigorous testing and debugging.<br/>Improved the operational speed of applications by optimizing code and streamlining processes.</h3>
					</VerticalTimelineElement>
					<VerticalTimelineElement
						className="vertical-timeline-element--work text-black"
